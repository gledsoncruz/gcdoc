...
basic = Plan.create(name: 'Plano Básico', price: 100.0, recurring: true, period: 'month', cycles: 12, num_doc: 50)
inter = Plan.create(name: 'Plano Intermediário', price: 200.0, recurring: true, period: 'month', cycles: 12, num_doc: 200)
advanced = Plan.create(name: 'Plano Avançado', price: 300.0, recurring: true, period: 'month', cycles: 12, num_doc: 1000)
